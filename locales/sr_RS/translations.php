...
return array(
    ...
    'When there is nothing to read, redirect me to this page' => 'Када нема ничег за читање, проследи ме на',
    ...
    'Drag and drop this link to your bookmarks' => 'Превуците ову везу у ваше омиљене сајтове',
    ...
    'Do not fetch the content of articles' => 'Не скидај садржај чланака',
    'Remove automatically read items' => 'Аутоматски уклони прочитане ставке',
    'Never' => 'Никад',
    'After %d day' => array('После %d дан', 'После %d дана'),
    'unread' => 'непрочитано',
    'Unread' => 'Непрочитано',
    ...
    '%d minute ago' => array('Пре %d минут', 'Пре %d минута'),
    '%d hour ago' => array('Пре %d сат', 'Пре %d сата', 'Пре %d сати'),
    '%d day ago' => array('Пре %d дан', 'Пре %d дана'),
    ...
    'Remove this feed' => 'Уклони овај feed',
    'Miniflux' => 'Минифлукс',
    ...
    'Avoid mixed content warnings with HTTPS' => 'Избегавај упозорења о помешаном садржају кроз HTTPS',
    'Download favicons' => 'Скини иконице веб сајтова',
    'general' => 'опште',
    ...
    'Refresh interval in minutes for unread counter' => 'Интервал у минутима за бројач непрочитаних ставки',
    ...
    'Original link marks article as read' => 'Оригинална веза обележава чланке прочитаним',
